...
export const metadata: Metadata = {
  title: "ROI & Cost Calculators - Zero2AI",
  description: "Calculate your automation investment and ROI. See exactly how much you'll save with AI automation and get accurate project cost estimates.",
  alternates: {
    canonical: `${site.brand.domain}/pricing/calculators`,
    languages: {
      'en': `${site.brand.domain}/en/pricing/calculators`,
      'ar': `${site.brand.domain}/ar/pricing/calculators`,
    },
  },
};
          ...
          <div className="container mx-auto text-center max-w-5xl">
            <div className="inline-block mb-8">
              <span className="px-8 py-4 rounded-full bg-primary/20 text-primary border border-primary/30 text-lg font-bold backdrop-blur-sm">
                {isArabic ? "حاسبات دقيقة" : "Accurate Calculators"}
              </span>
            </div>
            <h1 className="text-5xl md:text-7xl font-black mb-6 bg-gradient-to-b from-foreground via-foreground to-foreground/60 bg-clip-text text-transparent">
              {isArabic ? "احسب استثمارك وعائدك" : "Calculate Your Investment & ROI"}
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              {isArabic
                ? "احصل على تقديرات دقيقة للتكلفة واكتشف مقدار التوفير مع أتمتة الذكاء الاصطناعي"
                : "Get accurate cost estimates and discover exactly how much you'll save with AI automation"}
            </p>
          </div>
        </section>

        <CalculatorsClient isArabic={isArabic} />
      </main>
      <Footer />
    </>
  );
