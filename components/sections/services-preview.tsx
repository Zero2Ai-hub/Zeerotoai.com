            ...
            {site.services.map((service) => {
              ...
              return (
                ...
                <Link href={`/services#${service.id}`} className="block h-full">
                  <GlowingBorder>
                    <Card className="h-full group relative overflow-hidden border-2 border-primary/30 hover:border-primary/60 bg-card/80 backdrop-blur-sm transition-all duration-500 hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-2 flex flex-col cursor-pointer">
                      ...
                      <CardHeader className="relative z-10">
                        ...
                        <div className="flex items-center justify-between gap-4 mb-2">
                          ...
                          <div className="w-14 h-14 flex-shrink-0 rounded-xl bg-gradient-to-br from-primary via-primary to-primary/80 flex items-center justify-center shadow-lg shadow-primary/40 group-hover:scale-110 group-hover:rotate-6 group-hover:shadow-xl group-hover:shadow-primary/60 transition-all duration-300">
